...
from src.commands import create_pr, new, next, start, done
...
class TestCommands(unittest.TestCase):
    ...
    def test_create_pr(self):
        ...
        push_origin_upstream_effect = results[1]
        checkout_effect = results[2]
        ...
        self.assertIsInstance(push_origin_upstream_effect, GitEffect)
        self.assertEqual(
            push_origin_upstream_effect.command,
            "git push -u origin branchName"
        )
        self.assertIsInstance(checkout_effect, GitEffect)
        self.assertEqual(
            checkout_effect.command,
            "git checkout master"
        )
    ...
    def test_new(self):
        ...
        create_branch_effect = results[0]
        sayTimeStartEffect = results[1]
        sleepEffect = results[2]
        sayTimeUpEffect = results[3]
        addAllEffect = results[4]
        commitAllEffect = results[5]
        pushAllEffect = results[6]
        outputEffect = results[7]
        checkoutEffect = results[8]
        deleteBranchEffect = results[9]
    ...
    def test_start(self):
        ...
        self.assertIsInstance(pullEffect2, GitEffect)
        self.assertEqual(
            pullEffect2.command,
            "git pull origin"
        )
